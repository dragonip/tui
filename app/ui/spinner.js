...
/**
 * Modified by Peter StJ to work in require js environment
 * @module spinner Module that prvides SVG spinner as load indicator
 * */
define(function() {
  ...
  proto = Spinner.prototype = {
	  /**
	   * @method spin
	   * @param {HTMLElement} The element where the spinner should be embeded
	   */
	...
	/**
	 * @method stop Stops the spinner and removes it from the DOM
	 */
    stop: function() {
      var self = this,
          el = self.el;
